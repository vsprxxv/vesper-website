    ...
    const handleSubmit = async () => {
      ...
      try {                                                                                                           
        ...
        if (data.success) {                                                                                             
          ...
          setSubmitted(true)                                                                                          
        } else if (res.status === 400 && data.error === 'Prayer not accepted') {
          setRejected(true)                                                                                             
        } else {
  ...
  '16px', textAlign: 'center' }}>                                                                                       
          ...
          <p style={{ color: '#9ca3af', fontSize: '15px', textAlign: 'center', lineHeight: '1.9', marginBottom: '48px'  
            ...
            Send your prayer into the stream. The current will take it. Water will give it form, and the chain will     
  remember. What vanishes will stay written there, quiet and shining.                                                   
          </p>                                                                                                        
